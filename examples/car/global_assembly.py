...
from car_assemblies import make_wheel_assembly, make_front_suspension_assembly, \
    make_rear_suspension_assembly, make_chassis_assembly
...
if __name__ == "__main__":
    ...
    rear_suspension_and_wheel_assembly = AssemblyGeometryNode(root=rear_suspension_assembly_)

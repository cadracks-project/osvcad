...
# import OCC.AIS
#
# from osvcad.ui.color import color
# from osvcad.ui.topology import solids, shells, faces, edges, wires
#
#
...
#             a_box = OCC.BRepPrimAPI.BRepPrimAPI_MakeBox(100, 50, 25)
#             a_box.Build()
#             self.p = Wx3dViewer(self)
#             self.p.display_shape(a_box.Shape())
#             self.Show()
#
#     app = wx.App()
#     frame = MyFrame()
